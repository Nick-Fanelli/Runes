...
public class Input {
    ...
    private static final int NUM_KEYS = 348;
    private static final int NUM_MOUSE_BUTTONS = 7;
    ...
    private static boolean[] mouseButtonsLast  = new boolean[NUM_MOUSE_BUTTONS];

    private static Vector2f mousePosition      = new Vector2f();
    private static Vector2f mousePositionLast  = new Vector2f();

    private static Vector2f absScrollPosition  = new Vector2f();
    private static Vector2f scrollPosition      = new Vector2f();
    ...
    public void Update() {
        ...
        scrollPosition.zero(); // Clear the current scroll position
    }
    ...
    public void MouseScrollCallback(long window, double xOffset, double yOffset) {
        ...
        absScrollPosition.add((float) xOffset, (float) yOffset);
    }
    ...
    public static boolean IsMouseButton(int button) { return mouseButtons[button]; }
    public static boolean IsMouseButtonUp(int button) { return !mouseButtons[button] && mouseButtonsLast[button]; }
    public static boolean IsMouseButtonDown(int button) { return mouseButtons[button] && !mouseButtonsLast[button]; }
